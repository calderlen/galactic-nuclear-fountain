...
struct FitStatistics {
    ...
    std::optional<double> R_span_kpc;
    ...
    std::optional<double> residual_slope_dex_per_kpc;
    std::optional<double> e_residual_slope_dex_per_kpc;
    std::optional<double> pivot_kpc;
